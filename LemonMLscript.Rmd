...
*Note that while using the same seed "2020", running on a local Mac in a normal R session appears to generates different randomization and different prediction result than otherwise when "rmarkdown::render_site" the corresponding R markdown file to upload online. To reproduce the result published in our paper, simply copy the script presented here and re-run the script in a local computer environemnt in a normal R session.* 
...
# Raw data tidy up
```{r, message=F, warning=F}
path = "/Users/Boyuan/Desktop/My publication/14. Lemon juice (Weiting)/Lemon paper data_B.Y.xlsx"
