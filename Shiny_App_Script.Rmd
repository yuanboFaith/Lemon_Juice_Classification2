        ...
        mainPanel(
            tabsetPanel(
                ...
                tabPanel("Batch sample prediction",
                         ...
                         p("The default presents the prediction result of the template data", em("per se,"), "which is also the dataset used to train the models. For user’s reference, original samples 1-26 are AULJ, 27-62 ADLJ, and 63-86 LMND.", style = "color:black; font-size:105%;"),  
